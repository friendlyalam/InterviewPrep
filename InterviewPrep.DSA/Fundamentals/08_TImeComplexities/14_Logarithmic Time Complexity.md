...
O(log n) means the algorithm reduces the problem size by a constant factor (commonly half) during each iteration, resulting in very slow growth in the number of operations.
